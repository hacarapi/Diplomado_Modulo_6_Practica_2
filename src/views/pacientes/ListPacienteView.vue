<template>
    <div class="container">
        <Modal v-model:modelValue="showModalNuevo">
            <NewPacienteView @on-register="onRegister($event)" />
        </Modal>
...
import NewPacienteView from './NewPacienteView.vue'
...
export default {
    ...
    methods: {
        ...
        getList() {
            const vm = this;
            this.axios.get(this.baseUrl + "/pacientes?_expand=nombre&q=" + this.textToSearch)
